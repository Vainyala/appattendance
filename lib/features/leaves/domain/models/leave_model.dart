...
// // lib/features/leaves/domain/models/leave_model.dart
// // Final upgraded version: All statuses (including query), time fields, complete getters
// // Dec 30, 2025 - Production-ready, freezed, privileges safe (R01-R08)

// // All fields from employee_leaves table + all statuses (including query)
// // Privileges (R01-R08) safe, no context in model, computed getters safe
...
//     DateTime? createdAt,
//     DateTime? updatedAt,
//     // Time fields (optional, if added in future DB schema)
//     String? fromTime, // e.g., "09:00" (HH:mm string)
//     String? toTime, // e.g., "18:00"
//   }) = _LeaveModel;
